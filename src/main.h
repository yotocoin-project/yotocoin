...
static const int64 MAX_MONEY = 104000000 * COIN; // yotocoin: maximum of N coins (given some randomness), max transaction 10,000,000,000 for now
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > 2 * COIN * (60 * 24 / 0.25) / 250; // yotocoin: Priority cutoff is 2 yotocoin day / 250 bytes.
    }
